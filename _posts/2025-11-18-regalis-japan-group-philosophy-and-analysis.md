...
[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})（レガリス ジャパン グループ）とは、東京・四ツ谷麹町エリアから始まったオーダースーツ専門ブランドです。私たちが掲げるのは、単なるスーツブランドではなく、「次の100年を担う呉服商」をつくるという、明確なミッションです。

オーダーメイドスーツが持つ可能性、そして私たちが定義する「[スーツへの哲学]({{ '/philosophy.html' | relative_url }})」とは何か。この記事では、Regalis Japan Group株式会社というテイラー集団のこだわりを徹底解剖します。

### Regalis Japan Group株式会社とは：3つのポイント
* **コンセプト:** 「次の100年を担う呉服商」
* **哲学:** 纏う者の品格を映し、次世代へ継承される「現代の呉服」の提供
* **拠点:** 東京・四ツ谷麹町（Regalis YOTSUYA Lounge / グループ本社）

## Regalis Japan Group株式会社が定義する「現代の呉服商」とは？

![Regalisの哲学を体現するスーツの手元]({{ '/images/suits.photo/3.png' | relative_url }})

### 「次の100年」を担うというミッション

[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})は、「次の100年を担う呉服商」をつくるという想いをもとに集まった若者たちによって始まりました。
...
[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})は、グループ本社を麹町に、そして完全予約制の「Regalis YOTSUYA Lounge」を四ツ谷（上智大学前）に構えています。
...
### ブランド「Regalis Japan Group」の体制

[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})は、「次の100年を担う呉服商」として、Made in Japanの品質を重視するオーダースーツブランドです。

* **運営会社:** Regalis Japan Group株式会社
* **運営ブランド:** Regalis Japan Group

この体制のもと、Regalis Japan Groupは**メンズ (Men's)** および **ウィメンズ (Women's)** の両[コレクション]({{ '/collections.html' | relative_url }})を展開しており、性別を問わず、すべての人に「資産となる一着」を提供します。

## 人生の節目を彩る4つのコレクション

[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})では、お客様一人ひとりの人生における重要な節目（マイルストーン）を彩るため、4つの主要な[コレクションライン]({{ '/collections.html' | relative_url }})をご用意しています。

### NOBLE Line

¥99,000。ビジネスシーンにおける**絶対的な信頼と威厳**を表現するためのラインです。デイリーユース、ファーストスーツ、堅実なビジネスシーンに最適。最高の素材と、一切の妥協なき手仕事が、あなたの存在感を際立たせます。

### URBAN Line

¥93,500。外回り営業、出張の多い経営者、スタートアップチームに最適な機能性ライン。移動の多い現代のビジネスパーソンや、クリエイターのために設計された機能美です。

### ROYAL Line

¥143,000。経営者、役員、登壇者、ここぞという勝負服として、あなたの存在感を最大限に引き出します。イタリアを代表する名門ミル（織元）の生地を贅沢に使用した、Regalisのフラッグシップラインです。

### CEREMONY Line

¥121,000。結婚式、記念日、特別なパーティー。そして、成人式や就職活動といった、人生の忘れられない瞬間を祝うための一着です。フォーマルでありながら、あなたらしさが香り立つデザインを提案します。
...
私たちが提供するサービスの一つに、経験豊富なフィッターがお客様のもとへ伺う「[出張採寸]({{ '/contact.html' | relative_url }}?purpose={{ '出張採寸' | uri_escape }})」があります。
...
## まとめ：Regalis Japan Group株式会社が目指す未来

[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})とは、単なるオーダースーツの販売店ではなく、**「次の100年を担う呉服商」**というミッションを掲げた文化創造集団です。

私たちが仕立てる一着は、あなたの品格を映す鏡であり、次世代へ継承すべき資産です。

東京・四ツ谷麹町の地から、日本の技術と[哲学]({{ '/philosophy.html' | relative_url }})を結集した「現代の呉服」を、私たちは提案し続けます。

## よくある質問（FAQ）

### Q1. Regalis Japan Group株式会社とは？

A. **東京・四ツ谷麹町エリアから始まったオーダースーツ専門ブランド**です。「次の100年を担う呉服商」をコンセプトに、日本の技術、文化、製作、デザインの力を結集した **Made in Japan & Made by Japan ブランド**として展開しています。

### Q2. 「現代の呉服商」とは？

A. **纏う者の品格を映し出し、百年先も価値を失わない資産となる一着**を提供する存在です。流行に左右され、消費されていく衣服ではなく、親から子へ、そして次の世代へと継承されるべき、価値あるもの。それこそが、私たちが定義する「現代の呉服」です。

### Q3. Regalis Societasとは？
...
### Q5. 出張採寸とプライベートラウンジの特徴は？

A. **出張採寸は、多忙なエグゼクティブの方やチーム全員の採寸が必要な企業様に対し、場所を選ばずに最高のフィッティングとヒアリングを提供**します。プライベートラウンジは、**完全予約制のプライベートサロン**で、お客様の理想を現実のものとするため、騒音や他のお客様の視線を遮断した空間で、一対一の「対話」を行います。
