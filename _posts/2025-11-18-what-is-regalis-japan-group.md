...
[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})は、**「次の100年を担う呉服商」**として、東京・四ツ谷麹町から始まったオーダースーツ専門ブランドです。
...
**特徴**: 「次の100年を担う呉服商」として、Made in Japan & Made by Japanの品質を重視しています。

**特徴**: 100%日本製の品質と、完全な個別対応を実現します。

### ブランド哲学

**特徴**: 「次の100年を担う呉服商」として、[ブランド哲学]({{ '/philosophy.html' | relative_url }})を重視しています。
...
**サービス**:
- **[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})**: オーダースーツ専門ブランドとして、様々なTPOに対応
- **Regalis cross hub**: 学生向け無料ラウンジ「cross one」を運営

**特徴**: Regalis Societas.として、[コレクション]({{ '/collections.html' | relative_url }})を提供しています。
...
**特徴**: EXECUTIVEシーンに対応した、最高級のオーダースーツを提供しています。

### MILESTONEシーン

**特徴**: MILESTONEシーン（入学式、卒業式、就活など）に対応した、最高級のオーダースーツを提供しています。
...
A2. **Regalis YOTSUYA Lounge**で、オーダースーツを提供しています。詳細は、お問い合わせフォームからご連絡ください。

**Q3. 価格帯は？**

A3. **Team'sシーンに対応した、最高級のオーダースーツを提供**しています。詳細は、お問い合わせフォームからご連絡ください。

---

## お問い合わせ

[四ツ谷麹町オーダースーツ「Regalis Japan Group」]({{ '/' | relative_url }})では、オーダースーツに関するお問い合わせを受け付けています。

**Journal、Contact**: 詳細は、[Journalページ]({{ '/journal.html' | relative_url }})または[Contactページ]({{ '/contact.html' | relative_url }})からご連絡ください。
...
A. **Regalis YOTSUYA Lounge**で、オーダースーツを提供しています。EXECUTIVE、MILESTONE、Team'sシーンに対応した、最高級のオーダースーツを提供しています。

### Q3. 価格帯は？

A. **用途によって異なります**。詳細は、お問い合わせフォームからご連絡ください。
