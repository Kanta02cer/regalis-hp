...
<title>API Documentation - Regalis Japan Group株式会社</title>
<meta name="description" content="日本の伝統と匠の技に裏打ちされた、世界に通用するモダンなラグジュアリーオーダースーツブランド。">
<link rel="canonical" href="https://regalis-order-suits.com/regalis-hp/suit-mbti-app/node_modules/postcss-selector-parser/API.html">

<!-- OGP Tags -->
<meta property="og:title" content="API Documentation - Regalis Japan Group株式会社">
<meta property="og:description" content="日本の伝統と匠の技に裏打ちされた、世界に通用するモダンなラグジュアリーオーダースーツブランド。">
<meta property="og:type" content="website">
<meta property="og:url" content="https://regalis-order-suits.com/regalis-hp/suit-mbti-app/node_modules/postcss-selector-parser/API.html">
...
<h3 id="nodecloneopts"><code class="language-plaintext highlighter-rouge">node.clone([opts])</code></h3>

<p>Returns a copy of a node, detached from any parent containers that the
original might have had.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">cloned</span> <span class="o">=</span> <span class="nx">node</span><span class="p">.</span><span class="nx">clone</span><span class="p">();</span>
</code></pre></div></div>
...
<p>Returns the node at the source position <code class="language-plaintext highlighter-rouge">line</code> and <code class="language-plaintext highlighter-rouge">column</code>.</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// Input: :not(.foo),\n#foo &gt; :matches(ol, ul)</span>
<span class="nx">selector</span><span class="p">.</span><span class="nx">atPosition</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">1</span><span class="p">);</span> <span class="c1">// =&gt; :not(.foo)</span>
<span class="nx">selector</span><span class="p">.</span><span class="nx">atPosition</span><span class="p">(</span><span class="mi">2</span><span class="p">,</span> <span class="mi">1</span><span class="p">);</span> <span class="c1">// =&gt; \n#foo</span>
</code></pre></div></div>

<p>Arguments:</p>

<ul>
  <li><code class="language-plaintext highlighter-rouge">line</code>: The line number of the node to return.</li>
  <li><code class="language-plaintext highlighter-rouge">column</code>: The column number of the node to return.</li>
</ul>
