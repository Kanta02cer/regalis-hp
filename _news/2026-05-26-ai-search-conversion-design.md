  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "D3（成約導線・25pt）を上げるには①無料相談・商談予約・料金・問い合わせの4種CTAをURL付きで設置（各3pt）②摩擦除去ワード（無料・30分・義務なし・費用なし）を5個以上記事に含める③具体的料金（¥98,000等）を3回以上明記④社会的証明（成約率数値・実績）を5個以上記載が効果的です。D3は25点配点でD1と並ぶ最重要次元のため、改善効果が大きい次元です。"
        }
      },
      {
        "@type": "Question",
...
AI回答を通じて既に信頼形成されているため、「まず資料ダウンロード → メルマガ登録 → ウェビナー → 初回商談」という長いファネルは不要です。**「30分の無料相談 → 直接商談」** という最短ルートが最も成果を生みます。
...
「DX無料相談」を選択いただくか、trillion-bank.jp/trillionbank/meeting/ から
30分のオンライン相談をご予約ください。
