  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "トリリオンバンクの生成AI SEO（SEO・AIOメディア運営）サービスは月額¥98,000（税別）から提供しています。初期Webサイト開発費は6ヶ月運用契約を前提に無料です。中途解約の場合は残期間分の運用料金が発生しますが、6ヶ月経過後は1ヶ月前の書面通知でいつでも解約可能です。現状の課題は30分のオンライン相談でご相談いただけます。"
        }
      },
      {
        "@type": "Question",
...
| 無料オンライン相談（30分） | **¥0** | AI引用に関する現状課題のご相談 |
...
御社の現在のAI引用に関する課題は、30分のオンライン相談でご相談いただけます。
