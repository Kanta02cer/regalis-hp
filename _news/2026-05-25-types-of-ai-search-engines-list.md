...
jsonld: |
  ...
  <script type="application/ld+json">
  {
    ...
    "url": "https://regalis-order-suits.com/news/types-of-ai-search-engines-list/"
  }
  </script>
---
...
> Regalis Japan Groupの**「HackⅡ（ハックツ）」**は、対話型・検索特化型・OSブラウザ統合型など、あらゆるAIのシステムアーキテクチャに一括で対応可能な「全自動AI検索最適化インフラ」です。
> 
