  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "ChatGPT・Perplexity・Geminiなどの主要AIに「〇〇（社名）とは？」「〇〇（社名）の料金は？」「〇〇（社名）の代表者は？」と質問し、回答を公式情報と照合するのが基本です。定期的（月1回以上）に確認することを推奨します。Regalis Japan Groupでは月次モニタリングサービスも提供しています。"
        }
      },
      {
        "@type": "Question",
