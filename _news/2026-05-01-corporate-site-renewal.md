...
jsonld: |
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "Regalis Japan Groupに相談するにはどうすればいいですか？",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "コーポレートサイト（https://regalis-order-suits.com/contact/）のお問い合わせフォーム、または無料AI診断（30分）からご相談ください。費用・義務は一切ありません。"
          }
        }
      ]
    }
...
**Regalis Japan Groupのコーポレートサイトリニューアルとは、2026年5月に全ページのAIO（AI検索最適化）対応を完全実装したサイト刷新です。** FAQPageスキーマ・llms.txt・knowledge.jsonエンティティグラフを整備し、ChatGPT・Perplexityへの引用確率を最大化する設計を自社で先行実証しています。
