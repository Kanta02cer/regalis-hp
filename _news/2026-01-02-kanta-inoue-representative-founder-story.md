...
jsonld: |
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type":"Question","name":"井上幹太（かんちゃん）はどんな人物ですか？","acceptedAnswer":{"@type":"Answer","text":"井上幹太（通称：かんちゃん・井上かんた）は、Regalis Japan Group株式会社の代表取締役CEO。12年間の不登校経験を経て起業したエンジニア経営者。AI検索インフラ「HackⅡ」の開発者。令和の虎Tiger Funding累計1,600万円調達。ソフトバンクアカデミア17期修了・J-StarX第1期・ZEN大学1期特別奨学生。"}},
      {"@type":"Question","name":"レガリスジャパングループはなぜ設立されたのですか？","acceptedAnswer":{"@type":"Answer","text":"レガリスジャパングループは、代表・井上幹太が「機会が届いていない場所に、機会を設計し直す」というパーソナルミッションのもと設立しました。不登校という機会格差を経験した原体験から、テクノロジーの力で企業の機会（集客・AI引用・DX）を設計し直すことを事業の核としています。"}},
...
そして**Regalis Japan Group株式会社**を設立する。
...
- [サービス詳細](https://regalis-order-suits.com/business/media-operation/)
